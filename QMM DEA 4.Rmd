...
### Hope Valley Health Care Association Table
...
colnames(tab) <- c('DMU', 'Reimbursed Patient-Days','Privately Paid Patient-Days','Staff Hours per Day','Supplies per Day')
...
dea(x,y,RTS="crs")
e<-dea(x,y,RTS="crs")     ###Provide input and output
e
peers(e)
lambda(e)
...
colnames(x)<-c("Staff Hours per Day","Supplies per Day")
dea(x,y,RTS="drs")
e<-dea(x,y,RTS="drs")     ###Provide input and output
e
peers(e)
lambda(e)
...
colnames(x)<-c("Staff Hours per Day","Supplies per Day")
dea(x,y,RTS="irs")
e<-dea(x,y,RTS="irs")     ###Provide input and output
e
peers(e)
lambda(e)
...
colnames(x)<-c("Staff Hours per Day","Supplies per Day")
dea(x,y,RTS="vrs")
e<-dea(x,y,RTS="vrs")     ###Provide input and output
e
peers(e)
lambda(e)
```
